export type Category = 'Pensamientos' | 'Opiniones' | 'Ideas' | 'Programación' | 'Tecnología' | 'Viajes' | 'IA' | 'Música' | 'Libros' | 'Películas' | 'Series de TV' | 'Videojuegos' | 'Otros'

export const CategoryGradient: Record<Category, string> = {
  'Pensamientos': 'from-blue-500 to-purple-500',
